...
public class DB
{
    ...
    public static final String SQL_CREATE_PERSON_TABLE = "CREATE TABLE " + DB.Person.TABLE_NAME
            + " (" + DB.Person._ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
    ...
    public static final String SQL_CREATE_DEMOGRAPHICS_TABLE = "CREATE TABLE "
            + DB.Demographics.TABLE_NAME + " (" + DB.Demographics._ID
            ...
            + DB.Demographics.COLUMN_NAME_PHONE + " INT NULL" + COMMA_SEP 
            + " FOREIGN KEY (" + DB.Demographics.COLUMN_NAME_PERSONID + ") REFERENCES " 
            + DB.Person.TABLE_NAME + " (" + DB.Person._ID + "));"; 
    ...
    public static final String SQL_CREATE_CONDITIONS_TABLE = "CREATE TABLE "
            + DB.Conditions.TABLE_NAME + " (" + DB.Conditions._ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
    ...
    public static final String SQL_CREATE_PROVIDER_TABLE = "CREATE TABLE " + DB.Provider.TABLE_NAME
            + " (" + DB.Provider._ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
    ...
    public static final String SQL_CREATE_VISIT_TABLE = "CREATE TABLE " + DB.Visit.TABLE_NAME
            + " (" + DB.Visit._ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
            ...
            + DB.Visit.COLUMN_NAME_VISIT_DATE_TM + " DATE NOT NULL" + COMMA_SEP + COMMA_SEP
            + " FOREIGN KEY (" + DB.Visit.COLUMN_NAME_PROVIDERID + ") REFERENCES "
            + DB.Provider.TABLE_NAME + " (" + DB.Provider._ID + ")" + COMMA_SEP + " FOREIGN KEY ("
            + DB.Visit.COLUMN_NAME_PERSONID + ") REFERENCES " + DB.Person.TABLE_NAME + " ("
            + DB.Person._ID + "));";
    ...
    public static final String SQL_CREATE_SERVICES_TABLE = "CREATE TABLE " + DB.Services.TABLE_NAME
            + " (" + DB.Services._ID + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
    ...
    public static final String SQL_CREATE_APPOINTMENTS_TABLE = "CREATE TABLE "
            + DB.Demographics.TABLE_NAME + " (" + DB.Appointments._ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
            ...
            + DB.Person.TABLE_NAME + " (" + DB.Person._ID + ")" + COMMA_SEP
            + " FOREIGN KEY (" + DB.Appointments.COLUMN_NAME_PROVIDERID + ") REFERENCES " 
            + DB.Provider.TABLE_NAME + " (" + DB.Provider._ID + ")" + COMMA_SEP 
            + " FOREIGN KEY (" + DB.Appointments.COLUMN_NAME_LOCATIONID + ") REFERENCES " 
            + DB.Location.TABLE_NAME + " (" + DB.Location._ID + ")"
            + ");";
    ...
    public static final String SQL_CREATE_LOCATION_TABLE = "CREATE TABLE "
            ...
            + DB.Location.COLUMN_NAME_NAME + " VARCHAR (64) NOT NULL" + COMMA_SEP + " FOREIGN KEY ("
            + DB.Location.COLUMN_NAME_PROVIDERID + ") REFERENCES " + DB.Provider.TABLE_NAME + " ("
            + DB.Provider._ID + "));";
    ...
    public static final String SQL_CREATE_NOTIFICATIONS_TABLE = "CREATE TABLE "
            + DB.Notifications.TABLE_NAME + " (" + DB.Notifications._ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
            ...
            + DB.Notifications.COLUMN_NOTIF_DATE_TM + " DATE NOT NULL" + COMMA_SEP + " FOREIGN KEY ("
            + DB.Notifications.COLUMN_NAME_PROVIDERID + ") REFERENCES " + DB.Provider.TABLE_NAME + " ("
            + DB.Provider._ID + "));";
    ...
    public static final String SQL_CREATE_NOTES_TABLE = "CREATE TABLE "
            + DB.Notes.TABLE_NAME + " (" + DB.Notes._ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL" + COMMA_SEP
            + DB.Notes.COLUMN_NAME_PROVIDERID + " INT NOT NULL" + COMMA_SEP
            + DB.Notes.COLUMN_NAME_NOTE_TEXT + " VARCHAR (255) NOT NULL" + COMMA_SEP + " FOREIGN KEY ("
            + DB.Notes.COLUMN_NAME_PROVIDERID + ") REFERENCES " + DB.Provider.TABLE_NAME + " ("
            + DB.Provider._ID + "));";
